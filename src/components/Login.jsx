...
const Login = ({ toggleForm }) => {
  ...
  return (
    <div
      className="rounded-lg border-white border-opacity-10 border-2 shadow-2xl p-6 max-w-lg w-full backdrop-blur-md"
      style={{
        backgroundImage:
          "radial-gradient(circle 500px at 50% 50%, #134074, #00072d)",
      }}
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          className="w-full bg-blue-700 text-white p-3 rounded-xl hover:bg-sky-800 transform duration-300 shadow-xl font-semibold"
        >
          Login
        </button>
      </form>
